class Unit {
  ...
  attackTower() {
    ...
    let currentSquare = this.grid.gridAreaClicked(posX,posY);
      ...
      // console.log(this.grid.gridAreaClicked(688.7631499999916, 400+1));
     // console.log(this.grid.gridAreaClicked(688,400+1));
    // console.log(Math.round(this.x) , Math.round(this.y));
     // console.log(this.x, this.y ,this.grid.gridAreaClicked(Math.round(this.x),Math.round(this.y)));
